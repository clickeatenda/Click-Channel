// ========================================
// PARSER WEBHOOK - VERSÃO QUE FUNCIONA
// ========================================
// Baseado no código que está funcionando
// Com ajustes de propriedades

// Entrada bruta do Webhook
let raw = $input.item.json;

// Póde vir em body (string JSON) ou em payload
if (raw.body) {
  try {
...
if (lastRun && (now - lastRun) < 5 * 1000) {
  // Se processou há menos de 5 segundos, pula
  return [];
}
